...
- **`security`:** 
  - Configures security using Organizational Policies for centralized control and Security Command Center for centralized vulnerability and threat reporting. [Org Policies](https://cloud.google.com/resource-manager/docs/organization-policy/overview), [Security Command Center](https://cloud.google.com/security-command-center/docs/optimize-security-command-center).
- **`monitoring`:** 
