...
- **`service-projects`:**
  -  Service projects are created for both production and non-production environments to provide granular access control to specific subnets. [Learn more](https://cloud.google.com/docs/enterprise/best-practices/establish-projects)
- **`vpn`:**
...
### Option 1: Impersonate Service Account (recommended)
...
### Option 2: User Cloud Shell Directly or Local Machine (Pre-Authenticated)
